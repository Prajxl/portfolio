    ...
    return (
        <section className='c-space pt-7 pb-3 border-t  border-white flex justify-between items-center flex-wrap gap-5 '>
            ...
            <div className='flex mx-auto gap-3'>
                <a href="https://github.com/Prajxl" target="_blank" rel="noopener noreferrer" className='social-icon'>
                    <img src="/assets/github.svg" alt="github" className='w-1/2 h-1/2' />
                </a>

                <a href="https://linkedin.com/in/prajxl" target="_blank" rel="noopener noreferrer" className='social-icon'>
            ...
            <p className='text-white-500 mx-auto'>© {new Date().getFullYear()} Prajwal K. All rights reserved.</p>
        </section>
    )
}
